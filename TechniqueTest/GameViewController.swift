...
//        if let path = Bundle.main.path(forResource: "displacement", ofType: "plist") {
...
//                (self.view as! SCNView).technique = technique
//            }
//        }
        ...
        if let path = Bundle.main.url(forResource: "draw_normals", withExtension: "json") { 
            ...
            let tec = SCNTechnique.init(dictionary: techDict! as! [String : Any])
            (self.view as! SCNView).technique = tec
        }
